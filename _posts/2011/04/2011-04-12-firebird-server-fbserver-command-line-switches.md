...
* -a run as **a**pplication. Applicable only if Firebird runs as application.
* -n **n**o icon in the system tray. Applicable if Firebird runs as application.
* -b run with high (**b**oosted) priority.
* -r run with normal priority. This is default priority.
* -p specify **p**ort number/name or named pipe.
* -i accept tcp/**i**p connections.
* -l accept **l**ocal connections
